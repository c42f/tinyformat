...
#
# C99 printf            :  bloat_test.sh
# tinyformat            :  bloat_test.sh -DUSE_TINYFORMAT
# tinyformat, no inlines:  bloat_test.sh -DUSE_TINYFORMAT -DUSE_TINYFORMAT_NOINLINE
# boost::format         :  bloat_test.sh -DUSE_BOOST
# std::iostream         :  bloat_test.sh -DUSE_IOSTREAMS
#
